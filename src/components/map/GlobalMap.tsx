...
function makePin(fill = "rgb(245, 158, 11)") {
...
html.dark .ni-map-popup-noimg-icon {
  ...
  <button class="ni-map-popup-close" data-id="${m._id}">✕</button>
              ...
              <div class="ni-map-popup-body">
                ...
                <button class="ni-map-popup-view bg-gradient-to-r from-orange-700 via-orange-600 to-orange-400 text-white hover:opacity-90" data-id="${
                  m._id
    ...
    >
      ...
      {selectedMonument && (
        <MonumentDetailModal
          ...
          customStyle="bg-gradient-to-r from-orange-700 via-orange-600 to-orange-400 text-white hover:opacity-90"
        />
      )}
    </div>
  );
