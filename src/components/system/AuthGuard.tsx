...
const PUBLIC_PATHS = new Set<string>([
  ...
  '/tours/',
  '/tours',
  '/shortcuts/tourist-map/',
  '/shortcuts/tourist-map',
  '/shortcuts/tourist-attractions/',
  '/shortcuts/tourist-attractions',
  '/shortcuts/mt-kongo-and-katsuragi/',
  '/shortcuts/mt-kongo-and-katsuragi',
  '/shortcuts/meetings/',
  '/shortcuts/meetings',
  '/shortcuts/meetings/bus/',
  '/shortcuts/meetings/bus',
  '/shortcuts/meetings/gose-character/',
  '/shortcuts/meetings/gose-character',
  '/shortcuts/gourmet-products/',
  '/shortcuts/gourmet-products',
  '/shortcuts/facility/',
  '/shortcuts/facility',
  '/shortcuts/events/',
  '/shortcuts/events',
  '/shortcuts/city-promotion/',
  '/shortcuts/city-promotion',
  '/shortcuts/about/',
  '/shortcuts/about',
  '/tours/detail/',
